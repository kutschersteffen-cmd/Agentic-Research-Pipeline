...
export type MissingPolicy = "block" | "fail" | "pass";
...
export type ScreenRule = RuleBase &
  (
    | { type: "metric_threshold"; field: string; min_value?: number | null; max_value?: number | null; missing?: MissingPolicy }
    | { type: "flag_exclusion"; field: string; exclude_when?: boolean; missing?: MissingPolicy }
    | { type: "category_screen"; field: string; allow?: string[]; deny?: string[]; missing?: MissingPolicy }
  );
...
export type SelectionRule = RuleBase &
  (
    ...
    | { type: "top_n"; score_field: string; n: number; group_by?: string; higher_is_better?: boolean; missing?: MissingPolicy }
  );
...
export type TiltRule = RuleBase &
  (
    ...
    | { type: "bucket_tilt"; field: string; multipliers: Record<string, number>; default_multiplier?: number; missing?: MissingPolicy }
  );
